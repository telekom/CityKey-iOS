//
//  SCAusweisAuthEnterPukViewController.swift
//  OSCA
//
...
protocol SCAusweisAuthEnterPukViewDisplay : SCAusweisAuthPINViewDisplay {

}


class SCAusweisAuthEnterPukViewController: UIViewController {
    private weak var pinViewController : SCAusweisAuthPINViewController!
    var presenter : SCAusweisAuthEnterPukPresenting!
    ...
    private func updateLabels() {
        ...
        pinViewController.setHeader1(text: "egov_puk_info1".localized(), error: false)
    ...
    private func setupAccessibility(){
        ...
        pinViewController.heading1.accessibilityLabel = "egov_puk_info1".localized().localized()
...
extension SCAusweisAuthEnterPukViewController : SCAusweisAuthEnterPukViewDisplay {
