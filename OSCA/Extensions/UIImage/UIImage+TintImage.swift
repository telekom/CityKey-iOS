...
extension UIImage {
    ...
    func tintedHeaderImage(tintColor: UIColor) -> UIImage? {
        
        let grayImage = self.convertedToGrayImage()
        let darkenImage = grayImage?.lightened()
        
        return darkenImage?.tint(tintColor: tintColor)
    }
