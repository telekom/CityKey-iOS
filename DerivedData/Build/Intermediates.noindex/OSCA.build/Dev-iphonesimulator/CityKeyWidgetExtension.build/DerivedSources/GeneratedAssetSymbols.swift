...
extension ColorResource {
    ...
    static let wcHeader = ColorResource(name: "WCHeader", bundle: resourceBundle)

    /// The "WCbackground" asset catalog color resource.
    static let wCbackground = ColorResource(name: "WCbackground", bundle: resourceBundle)

    /// The "restmullWasteColor" asset catalog color resource.
    static let restmullWaste = ColorResource(name: "restmullWasteColor", bundle: resourceBundle)
    ...
    static let wasteCalendarBackground = ColorResource(name: "wasteCalendarBackground", bundle: resourceBundle)
...
extension ImageResource {
    ...
    static let trash = ImageResource(name: "trash", bundle: resourceBundle)
